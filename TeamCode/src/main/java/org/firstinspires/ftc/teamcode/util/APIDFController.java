...
import static org.firstinspires.ftc.teamcode.util.MiscKt.normalizeDegrees;

public class APIDFController {
     ...
     */
    public APIDFController(double kp, double ki, double kd, double kf) {
     ...
     */
    public APIDFController(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
