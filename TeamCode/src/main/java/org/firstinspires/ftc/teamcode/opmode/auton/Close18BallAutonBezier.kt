...
@Autonomous
class Close18BallBezierRed : Close18BallAutonBezier(true)

@Autonomous
class Close18BallBezierBlue : Close18BallAutonBezier(false)

@Configurable
open class Close18BallAutonBezier(var isRed: Boolean) : OpMode() {
    override fun run() {
        ...
        val autonManager = AutonManager(this, drive, "Close-18Ball-RampAndRows-BEZIER", isMirrored = !isRed)
        ...
        scheduler.schedule(Command("general") {
            OpModeLoop(this@Close18BallAutonBezier) {
