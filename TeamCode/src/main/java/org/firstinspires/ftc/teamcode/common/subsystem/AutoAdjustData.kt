...
val NO_RECOIL_DATA: TreeMap<Distance, Pair<RPM, Angle>> = treeMapOf(
    ...
    56.0 to (2900.0 to 0.0),
    60.0 to (3000.0 to 0.0),
    64.0 to (3000.0 to 0.0),
    68.0 to (3000.0 to 0.0),
    72.0 to (3100.0 to 0.1),
    76.0 to (3100.0 to 0.1),
    80.0 to (3200.0 to 0.2),
    84.0 to (3200.0 to 0.2),
    88.0 to (3300.0 to 0.3),
    92.0 to (3350.0 to 0.3),
    96.0 to (3500.0 to 0.35),
    100.0 to (3600.0 to 0.4),
    104.0 to (3700.0 to 0.5),
    108.0 to (3700.0 to 0.5),
)

val FAR_ZONE: Pair<RPM, Angle> = (4000.0 to .3)
